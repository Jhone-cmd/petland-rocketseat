...
public class CustomerServiceController {
    ...
    public ResponseEntity<Object> addProductOrService(@Valid @RequestBody CustomerServiceDTO customerServiceDTO) {
        ...
        try {
            var customerServiceEntity = CustomerServiceEntity.builder()
                    ...
                    .client(customerServiceDTO.getClient()).animal(customerServiceDTO.getAnimal()).service(customerServiceDTO.getService())
                    .build();
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateProductOrService(@PathVariable Integer id, @RequestBody CustomerServiceDTO customerServiceDTO) {
